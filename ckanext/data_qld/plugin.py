...
from .harvester import harvester_facets
...
class DataQldPlugin(CKANHarvester):
    ...
    def info(self):
        return harvester_facets.info(self)

    def validate_config(self, config):
        return harvester_facets.validate_config(self, config)

    def modify_package_dict(self, package_dict, harvest_object):
        return harvester_facets.modify_package_dict(self, package_dict, harvest_object)

    def gather_stage(self, harvest_job):
        return harvester_facets.gather_stage(self, harvest_job)
