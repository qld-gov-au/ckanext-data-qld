...
Feature: Engagement Reporting
    ...
    Scenario: As an admin user of my organisation, when I view my engagement report, I can verify the numbers are correct and increment
        ...
        And I should see an element with xpath "//tr[@id='closing-circumstance']/td[position()=1]/a[contains(@href, '/closed?') and string()='To be released as open data at a later date']"
